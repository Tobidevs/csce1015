...
print ("Tobi Akere's Credit Card Validator")
...
return luhn.verify(card_number)
print ("tobi Akere's credit card validatior")
card_number = input("enter your 16-digit credit card number:")
if is credit_card_valid(card_number):
    print("the credit card number is valid.")

    else:
    def is_credit_card_valid(card_number):
    print("tobi akere credit card valid.")
